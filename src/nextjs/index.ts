...
export class OttofellerNextjsProject extends NextJsTypeScriptProject {
  ...
  constructor(options: OttofellerNextjsProjectOptions) {
    ...
    // ANCHOR Tailwind
    this.addDeps('postcss', 'tailwindcss', 'autoprefixer', '@tailwindcss/line-clamp', '@tailwindcss/container-queries')
    ...
    new AssetFile(this, 'tailwind.config.defaults.js', {
      sourcePath: path.join(assetsDir, 'tailwind.config.defaults.js'),
    })

    new SampleFile(this, 'tailwind.config.js', {sourcePath: path.join(assetsDir, 'tailwind.config.js')})
