...
[API](../README.md) > RunScriptJobOptions

---
title: RunScriptJobOptions
---

# Interface: RunScriptJobOptions
...
[common/github/jobs/run-script-job.ts:10](https://github.com/ottofeller/templates/blob/0b981d6/src/common/github/jobs/run-script-job.ts#L10)
...
[`NodeJobOptions`](interface.NodeJobOptions.md).[`nodeVersion`](interface.NodeJobOptions.md#nodeversion)
...
[`NodeJobOptions`](interface.NodeJobOptions.md).[`projectPackage`](interface.NodeJobOptions.md#projectpackage)
...
[`NodeJobOptions`](interface.NodeJobOptions.md).[`ref`](interface.NodeJobOptions.md#ref)
...
[`NodeJobOptions`](interface.NodeJobOptions.md).[`registryUrl`](interface.NodeJobOptions.md#registryurl)
...
[`NodeJobOptions`](interface.NodeJobOptions.md).[`runScriptCommand`](interface.NodeJobOptions.md#runscriptcommand)
...
[`NodeJobOptions`](interface.NodeJobOptions.md).[`runsOn`](interface.NodeJobOptions.md#runson)
...
[`NodeJobOptions`](interface.NodeJobOptions.md).[`scope`](interface.NodeJobOptions.md#scope)
...
[`NodeJobOptions`](interface.NodeJobOptions.md).[`workingDirectory`](interface.NodeJobOptions.md#workingdirectory)
